                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body cleartfix">
                                        <div class="text-center">
                                            <h2 class="mr-2">
                                                {{number_format($allAccounts->sum('amount'),2)}}
                                            </h2>
                                        </div>
                                        <div class="text-center">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-12">
                                                <label>Bank Details : <span class="danger"> *</span></label>
                                            ...
                                            <div class="col-md-3 col-12">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control" name="created_at" required type="date">
                                                </div>
                                            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if(($Account->document ?? null) != null)
                                                                ...
                                                                <a href="{{asset('upload/account/'.($Account->document ?? null))}}" target="_blank" data-placement="top" data-toggle="tooltip"
                                                        ...
                                                        <td>
                                                            <span data-placement="top" data-toggle="tooltip"
                                                                ...
                                                                <a class="btn btn-warning btn-xs updateModal"
                                                                   ...
                                                                   data-goto="{{$Account->bank_id}}"
                                                                   data-toggle="{{$Account->status}}"
                                                                   datatype="{{date('Y-m-d',strtotime($Account->created_at))}}">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-12">
                                                <label>Bank Details : <span class="danger"> *</span></label>
                                                <div class="form-group">
                                                    <select class="form-control BankID" name="bank_id">
        ...
        ;(function ($) {
            $(document).ready(function () {
                ...
                $('.updateModal').click(function () {
                    ...
                    bank_id = $(this).attr('data-goto');
                    updateDate = $(this).attr('datatype');

                    $(".BankID option[value=" + bank_id + "]").attr("selected", "selected");
